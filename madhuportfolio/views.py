...
def index(request):
    ...
    return render(request, 'madhuportfolio/index.html', context)
...
def adminlogin(request):
    ...
    return render(request, 'madhuportfolio/admin/adminlogin.html', {'error': error})
...
def dashboard(request):
    ...
    return render(request, 'madhuportfolio/admin/dashboard.html')
...
def home(request):
    ...
    return render(request, 'madhuportfolio/admin/home.html', {'hero': hero})
...
def about(request):
    ...
    return render(request, 'madhuportfolio/admin/about.html', {'about': about})
...
def languages(request, id=None):
    ...
    return render(request, 'madhuportfolio/admin/language.html', {
...
def frameworkapi(request, id=None):
    ...
    return render(request, 'madhuportfolio/admin/frameworkapi.html', {
...
def databases(request, id=None):
    ...
    return render(request, 'madhuportfolio/admin/database.html', {
...
def toolsplatforms(request, id=None):
    ...
    return render(request, 'madhuportfolio/admin/toolsplatforms.html', {
        'tools': tools_list,
        'tool': tool
    })
...
def webtech(request, id=None):
    ...
    return render(request, 'madhuportfolio/admin/webtech.html', {
        'web_list': web_list,
        'web': web
    })
...
def coreconcept(request, id=None):
    ...
    return render(request, 'madhuportfolio/admin/coreconcepts.html', {
...
def projects(request, project_id=None):
    ...
    return render(request, 'madhuportfolio/admin/projects.html', context)
...
def experience(request, exp_id=None):
    ...
    return render(request, 'madhuportfolio/admin/experience.html', {
...
def contact(request):
    ...
    return render(request, 'madhuportfolio/admin/contact.html', {
        'contact': contact
    })
...
def social_media(request, id=None):
    ...
    return render(request, 'madhuportfolio/admin/socialmedia.html', {
        'social': social,
        'socials': socials
    })
